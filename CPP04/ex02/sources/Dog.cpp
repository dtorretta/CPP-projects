...
/*   Updated: 2025/03/21 23:52:31 by marvin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Default constructor
Dog::Dog(void): AAnimal() //no puedo hacer _brain(NULL) como hcie en HUMANA porque todavia no esta creado el elemento
{
	this->_type = "Dog";
...
Dog::Dog(const Dog& copy) : AAnimal(copy) //llama directamente al copy constructor de la clase base
{
