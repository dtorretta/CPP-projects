...
void RPN::processOperation(const std::string &rpn)
{
    ...
    std::string token;
    while(iss >> token) // Cada iteración sobrescribe el contenido anterior con el siguiente token. token siempre contiene un solo token del RPN en cada iteración.
    {
